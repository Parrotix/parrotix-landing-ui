...
const socials = [
  {
    name: 'Instagram',
    href: 'https://www.instagram.com/parrotix_app/',
    icon: (
  ...
  {
    name: 'Facebook',
    href: 'https://www.facebook.com/profile.php?id=61582641613869',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  {
    name: 'YouTube',
    href: 'https://www.youtube.com/@Parrotix_app',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-10">
          ...
          <div className="md:col-span-2">
            <a href="#" className="flex items-center gap-2.5 mb-5 group">
              ...
              />
              <span className="text-2xl font-fredoka font-bold text-white">Parrotix</span>
            </a>
            <p className="text-gray-500 font-inter text-sm leading-relaxed mb-6 max-w-xs">
              Gamified English learning for Urdu speakers. Earn XP, build streaks, and master
              English through 8 exciting game modes.
            </p>
            ...
            <div className="flex items-center gap-3">
              {socials.map((s) => (
                <a
                  ...
                  aria-label={s.name}
                  className="w-9 h-9 rounded-xl bg-white/5 flex items-center justify-center text-gray-400 hover:text-white hover:bg-brand-blue/20 transition-all duration-200"
                >
                  {s.icon}
                </a>
              ))}
